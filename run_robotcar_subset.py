...
if __name__ == '__main__':
    ...
    for k in range(len(query_images)):
        ...
        if args.output in ["all", "correspondences", "keypoint_movement"]:
            ...
            cache_item = cache["/local/home/ntselepidis/3DV/RobotCar-Seasons/images/"+query_images[k].replace(image_root,"")].item()
            ...
            if args.output in ["all", "keypoint_movement"]:
                outliers_ref = [False for l in cache_item["reference_2D"][cache_item["inlier_mask"]]]
